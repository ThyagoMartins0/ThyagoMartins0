...
<p align="center">Se existe problema, existe solução <br><br> Backend developer using Laravel/Node, I am <strong>passionate to discover new stuffs</strong> and use them to create high quality solutions. Today, I'm a <strong>full stack mid-level developer</strong> focused on web development.</p>&nbsp;
